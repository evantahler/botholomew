...
const REPO = "evantahler/botholomew";
...
function renderBody(body) {
  ...
  return body
    .replace(
      ...
      `* <a href="https://github.com/${REPO}/pull/$2" target="_blank" rel="noopener" class="pr-link">#$2</a> $1`,
    )
    .replace(
...
<template>
  <div class="changelog">
    ...
    <div v-else-if="releases.length === 0" class="changelog-empty">
